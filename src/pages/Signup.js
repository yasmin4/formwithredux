    ...
    const handleOnSubmit = (event) => {
        ...
        if (form.checkValidity() === false) {
            ...
            if (isEmailAlreadyExist) {
                toast.error(
                    "this email adress is alredy register plese try with another one or Log in !",
                    {
    ...
    return (
        <div>
                ...
                <Form noValidate validated={validated} onSubmit={handleOnSubmit}>
                    <Row>
                        <Inputbox
                            ...
                            validFeedback="valid"
                            invalidFeedBack="Enter Valid First Name"
                            classname="col-sm-6"
                        />
            ...
            <div className="btnRedirect">
                <input type="button" class="btn btn-light btn-lg" value="Login" onClick={handleLogin} />
            </div>
        </div>
    );
}
